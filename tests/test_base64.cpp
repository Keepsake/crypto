...
TEST(Base64, CanBeReused)
{
  ks::crypto::base64_encoder encoder{};
  ks::crypto::base64_decoder decoder{};

  auto const long_decoded = read_test_data("base64_decoded_long_data");
  auto const long_encoded = read_test_data("base64_encoded_long_data");
